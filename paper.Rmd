...
```{r screenshot, echo=FALSE, fig.cap="The MVA section of `MAVIS`, showing the trajectory of quadrat 10 from the Leith Hill Wood example dataset in the ordination spaces over time."}
knitr::include_graphics("images/Screenshot from 2024-02-22 06-58-09.png") 
``` 
