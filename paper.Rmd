...
```{r screenshot, echo=FALSE, fig.cap="The MVA section of `RMAVIS`, showing the trajectory of all sample plots from the Leith Hill Wood example dataset in the ordination spaces over time."}
knitr::include_graphics("images/Screenshot from 2024-03-05 12-25-49.png") 
``` 
